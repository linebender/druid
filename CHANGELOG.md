...
- `TransformBox`, `TransformPolicy`, `AARotation`, `AATRansform`, `CenterRotation`, `BoundedRotation`, `FreeAffine`, `BoundedAffine` ([#1799] by [@xarvic])
...
[#1799]: https://github.com/linebender/druid/pull/1799
