...
use crate::{
    BoxConstraints, Geometry, HandlerCtx, Id, KeyEvent, LayoutCtx, LayoutResult, MouseEvent,
    PaintCtx, Ui, KeyVariant
};

use kurbo::{Rect, Line};
use piet::{FillRule, Font, FontBuilder, RenderContext, Text, TextLayoutBuilder, TextLayout};
use piet_common::{Piet, CairoFont};
    ...
    fn get_layout(&mut self, rt: &mut Piet, font_size: f32) -> <Piet as RenderContext>::TextLayout {
        ...
        match &self.font {
          ...
          _ => {
            ...
            //but it solved my borrwing issues!
...
impl Widget for TextBox {
    fn paint(&mut self, paint_ctx: &mut PaintCtx, geom: &Geometry) {
        ...
        if paint_ctx.is_focused() {
          ...
          let (x, y) = (geom.pos.0 + text_layout.width() as f32 + 2., geom.pos.1 + 2.);
          
          let line = Line::new((x as f64,y as f64), (x as f64, y as f64 + font_size as f64)); 
