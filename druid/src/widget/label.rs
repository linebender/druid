...
impl<T: Data> Widget<T> for Label<T> {
    #[instrument(skip(self, _ctx, _event, _data, _env))]
    ...
    #[instrument(skip(self, ctx, bc, _data, env))]
    fn layout(&mut self, ctx: &mut LayoutCtx, bc: &BoxConstraints, _data: &T, env: &Env) -> Size {
        self.label.layout(ctx, bc, &self.current_text, env)
    }

    #[instrument(skip(self, ctx, _data, env))]
...
impl<T: TextStorage> Widget<T> for RawLabel<T> {
    #[instrument(skip(self, _ctx, _event, _data, _env))]
    fn event(&mut self, _ctx: &mut EventCtx, _event: &Event, _data: &mut T, _env: &Env) {}
    #[instrument(skip(self, _ctx, event, data, _env))]
    ...
    #[instrument(skip(self, ctx, old_data, data, _env))]
    ...
    #[instrument(skip(self, ctx, _data, _env))]
