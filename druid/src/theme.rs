...
use crate::{key, Env, FontDescriptor, FontFamily, FontStyle, FontWeight, Insets, Key};

pub const WINDOW_BACKGROUND_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.window_background_color",
    Color::rgb8(0x29, 0x29, 0x29)
);

pub const LABEL_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.label_color",
    Color::rgb8(0xf0, 0xf0, 0xea)
);
pub const PLACEHOLDER_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.placeholder_color",
    Color::rgb8(0x80, 0x80, 0x80)
);

pub const PRIMARY_LIGHT: Key<Color> = key!(
    "org.linebender.druid.theme.primary_light",
    Color::rgb8(0x5c, 0xc4, 0xff)
);
pub const PRIMARY_DARK: Key<Color> = key!(
    "org.linebender.druid.theme.primary_dark",
    Color::rgb8(0x00, 0x8d, 0xdd)
);
pub const PROGRESS_BAR_RADIUS: Key<f64> =
    key!("org.linebender.druid.theme.progress_bar_radius", 4.);
pub const BACKGROUND_LIGHT: Key<Color> = key!(
    "org.linebender.druid.theme.background_light",
    Color::rgb8(0x3a, 0x3a, 0x3a)
);
pub const BACKGROUND_DARK: Key<Color> = key!(
    "org.linebender.druid.theme.background_dark",
    Color::rgb8(0x31, 0x31, 0x31)
);
pub const FOREGROUND_LIGHT: Key<Color> = key!(
    "org.linebender.druid.theme.foreground_light",
    Color::rgb8(0xf9, 0xf9, 0xf9)
);
pub const FOREGROUND_DARK: Key<Color> = key!(
    "org.linebender.druid.theme.foreground_dark",
    Color::rgb8(0xbf, 0xbf, 0xbf)
);
pub const BUTTON_DARK: Key<Color> = key!("org.linebender.druid.theme.button_dark", Color::BLACK);
pub const BUTTON_LIGHT: Key<Color> = key!(
    "org.linebender.druid.theme.button_light",
...
pub const BORDER_DARK: Key<Color> = key!(
    "org.linebender.druid.theme.border_dark",
    Color::rgb8(0x3a, 0x3a, 0x3a)
);
pub const BORDER_LIGHT: Key<Color> = key!(
    "org.linebender.druid.theme.border_light",
...
pub const SELECTED_TEXT_BACKGROUND_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.selection_color",
    Color::rgb8(0x43, 0x70, 0xA8)
);
pub const SELECTED_TEXT_INACTIVE_BACKGROUND_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.selection_color_inactive",
    Color::grey8(0x74)
);
pub const SELECTION_TEXT_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.selection_text_color",
...
pub const UI_FONT: Key<FontDescriptor> = key!(
    "org.linebender.druid.theme.ui-font",
    FontDescriptor::new(FontFamily::SYSTEM_UI).with_size(15.0)
);

/// A bold version of the default UI font.
pub const UI_FONT_BOLD: Key<FontDescriptor> = key!(
    "org.linebender.druid.theme.ui-font-bold",
...
pub const UI_FONT_ITALIC: Key<FontDescriptor> = key!(
    "org.linebender.druid.theme.ui-font-italic",
    FontDescriptor::new(FontFamily::SYSTEM_UI)
...
pub const TEXTBOX_INSETS: Key<Insets> = key!(
    "org.linebender.druid.theme.textbox_insets",
    Insets::new(4.0, 4.0, 4.0, 4.0)
);
...
pub const WIDGET_CONTROL_COMPONENT_PADDING: Key<f64> = key!(
    "org.linebender.druid.theme.widget-padding-control-label",
    4.0
);

pub const SCROLLBAR_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.scrollbar_color",
    Color::rgb8(0xff, 0xff, 0xff)
);
pub const SCROLLBAR_BORDER_COLOR: Key<Color> = key!(
    "org.linebender.druid.theme.scrollbar_border_color",
    Color::rgb8(0x77, 0x77, 0x77)
);
