...
pub const SECONDARY_LIGHT: Key<Color> = Key::new("secondary_light");
pub const SECONDARY_DARK: Key<Color> = Key::new("secondary_dark");
...
pub fn init() -> Env {
    let mut env = Env::default()
        ...
        .adding(SECONDARY_LIGHT, Color::rgb8(0xff, 0x67, 0x37))
        .adding(SECONDARY_DARK, Color::rgb8(0xff, 0x3d, 0x00))
