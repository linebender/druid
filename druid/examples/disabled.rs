use druid::{Widget, WidgetExt, WindowDesc, LocalizedString, AppLauncher, Data, Lens};
use druid::widget::{Flex, TextBox, Label, Slider, Checkbox, Switch, Stepper, CrossAxisAlignment};
...
pub fn main() {
    let window = WindowDesc::new(main_widget()).title(
        LocalizedString::new("disabled-demo-window-title")
            .with_placeholder("Disabled demo"),
    );
