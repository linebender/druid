...
impl From<u32> for KeyCode {
    ...
    fn from(raw: u32) -> KeyCode {
        match raw {
            ...
            /* The GTK platform treats these as though numlock were off */
            KP_Insert => KeyCode::Numpad0,
            KP_End => KeyCode::Numpad1,
            KP_Down => KeyCode::Numpad2,
            KP_Page_Down => KeyCode::Numpad3,
            KP_Left => KeyCode::Numpad4,
            KP_Begin => KeyCode::Numpad5,
            KP_Right => KeyCode::Numpad6,
            KP_Home => KeyCode::Numpad7,
            KP_Up => KeyCode::Numpad8,
            KP_Page_Up => KeyCode::Numpad9,

            KP_Equal => KeyCode::NumpadEquals,
            KP_Subtract => KeyCode::NumpadSubtract,
            KP_Add => KeyCode::NumpadAdd,
            KP_Delete => KeyCode::NumpadDecimal,
