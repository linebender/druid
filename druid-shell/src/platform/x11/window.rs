...
impl WindowBuilder {
    ...
    pub fn set_min_size(&mut self, min_size: Size) {
        tracing::warn!("WindowBuilder::set_min_size is implemented, but the setting is currently unused for X11 platforms.");
        self.min_size = min_size;
    }

    pub fn resizable(&mut self, _resizable: bool) {
        tracing::warn!("WindowBuilder::resizable is currently unimplemented for X11 platforms.");
    }

    pub fn show_titlebar(&mut self, _show_titlebar: bool) {
        tracing::warn!("WindowBuilder::show_titlebar is currently unimplemented for X11 platforms.");
    }

    pub fn set_position(&mut self, _position: Point) {
        tracing::warn!("WindowBuilder::set_position is currently unimplemented for X11 platforms.");
    }

    pub fn set_level(&mut self, _level: window::WindowLevel) {
        tracing::warn!("WindowBuilder::set_level  is currently unimplemented for X11 platforms.");
    }

    pub fn set_window_state(&self, _state: window::WindowState) {
        tracing::warn!("WindowBuilder::set_window_state is currently unimplemented for X11 platforms.");
    }
    ...
    pub fn build(self) -> Result<WindowHandle, Error> {
        ...
        let present_data = match self.initialize_present_data(id) {
            Ok(p) => Some(p),
            Err(e) => {
                tracing::info!("Failed to initialize present extension: {}", e);
                None
            }
        };
...
impl Window {
    ...
    pub fn destroy(&self) {
        if !self.destroyed() {
            match borrow_mut!(self.state) {
                ...
                Err(e) => tracing::error!("Failed to set destroyed flag: {}", e),
            }
    ...
    fn update_cairo_surface(&self) -> Result<(), Error> {
        ...
        let pixmap = if let Some(p) = buffers.idle_pixmaps.last() {
            *p
            ...
            tracing::info!("ran out of idle pixmaps, creating a new one");
    ...
    fn resizable(&self, _resizable: bool) {
        tracing::warn!("Window::resizeable is currently unimplemented for X11 platforms.");
    }

    /// Set whether the window should show titlebar
    fn show_titlebar(&self, _show_titlebar: bool) {
        tracing::warn!("Window::show_titlebar is currently unimplemented for X11 platforms.");
    }
    ...
    fn invalidate(&self) {
        match self.size() {
            ...
            Err(err) => tracing::error!("Window::invalidate - failed to get size: {}", err),
        }
    }

    fn invalidate_rect(&self, rect: Rect) {
        if let Err(err) = self.add_invalid_rect(rect) {
            tracing::error!("Window::invalidate_rect - failed to enlarge rect: {}", err);
        }
    ...
    pub(crate) fn run_idle(&self) {
        ...
        if needs_redraw {
            if let Err(e) = self.redraw_now() {
                tracing::error!("Error redrawing: {}", e);
            }
        }
    }
...
fn mouse_button(button: u8) -> MouseButton {
    match button {
        ...
        9 => MouseButton::X2,
        _ => {
            tracing::warn!("unknown mouse button code {}", button);
            MouseButton::None
        }
    }
}
    ...
    fn wake(&self) {
        loop {
            match nix::unistd::write(self.pipe, &[0]) {
                ...
                Err(e) => {
                    tracing::error!("Failed to write to idle pipe: {}", e);
                    break;
                }
                Ok(_) => {
                    break;
...
impl WindowHandle {
    ...
    pub fn show(&self) {
        if let Some(w) = self.window.upgrade() {
            ...
            tracing::error!("Window {} has already been dropped", self.id);
        }
    }
    ...
    pub fn set_position(&self, _position: Point) {
        tracing::warn!("WindowHandle::set_position is currently unimplemented for X11 platforms.");
    }

    pub fn get_position(&self) -> Point {
        tracing::warn!("WindowHandle::get_position is currently unimplemented for X11 platforms.");
        Point::new(0.0, 0.0)
    }

    pub fn content_insets(&self) -> Insets {
        tracing::warn!("WindowHandle::content_insets unimplemented for X11 platforms.");
        Insets::ZERO
    }

    pub fn set_level(&self, _level: WindowLevel) {
        tracing::warn!("WindowHandle::set_level  is currently unimplemented for X11 platforms.");
    }

    pub fn set_size(&self, _size: Size) {
        tracing::warn!("WindowHandle::set_size is currently unimplemented for X11 platforms.");
    }

    pub fn get_size(&self) -> Size {
        tracing::warn!("WindowHandle::get_size is currently unimplemented for X11 platforms.");
        Size::new(0.0, 0.0)
    }

    pub fn set_window_state(&self, _state: window::WindowState) {
        tracing::warn!("WindowHandle::set_window_state is currently unimplemented for X11 platforms.");
    }

    pub fn get_window_state(&self) -> window::WindowState {
        tracing::warn!("WindowHandle::get_window_state is currently unimplemented for X11 platforms.");
        window::WindowState::RESTORED
    }

    pub fn handle_titlebar(&self, _val: bool) {
        tracing::warn!("WindowHandle::handle_titlebar is currently unimplemented for X11 platforms.");
    }
    ...
    pub fn make_cursor(&self, _cursor_desc: &CursorDesc) -> Option<Cursor> {
        tracing::warn!("Custom cursors are not yet supported in the X11 backend");
        None
    }

    pub fn open_file(&mut self, _options: FileDialogOptions) -> Option<FileDialogToken> {
        // TODO(x11/file_dialogs): implement WindowHandle::open_file
        tracing::warn!("WindowHandle::open_file is currently unimplemented for X11 platforms.");
        None
    }
    ...
    pub fn save_as(&mut self, _options: FileDialogOptions) -> Option<FileDialogToken> {
        ...
        tracing::warn!("WindowHandle::save_as is currently unimplemented for X11 platforms.");
        None
    }

    pub fn show_context_menu(&self, _menu: Menu, _pos: Point) {
        // TODO(x11/menus): implement WindowHandle::show_context_menu
        tracing::warn!("WindowHandle::show_context_menu is currently unimplemented for X11 platforms.");
    }
